    ...
    datasets: [
      {
        data: [],
        label: `Price Trends`,
        backgroundColor: 'rgba(109,180,218)',
        borderColor: '#6db4da',
        pointBackgroundColor: '#6db4da',
        pointBorderColor: '#6db4da',
        pointHoverBackgroundColor: '#6db4da',
        pointHoverBorderColor: '#6db4da',
      }
    ],
    labels: []
  };
